...
const sendEmail = async ({ to, subject, html, text }) => {
  try {
    ...
    const mailOptions = {
      from: `"USPS Label Portal" <${process.env.EMAIL_USER}>`,
      to,
      subject,
      html,
...
const emailTemplates = {
  fileUploaded: (userName, fileName, fileType) => ({
    subject: `New ${fileType} File Uploaded - USPS Label Portal`,
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        ...
        <br><br>
        <p>Best regards,<br>USPS Label Portal System</p>
      </div>
    `
  }),

  labelsGenerated: (userName, fileName, downloadUrl) => ({
    subject: `Your Labels Are Ready - USPS Label Portal`,
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
  ...
  userCreated: (userName, email, password, role) => ({
    subject: `Welcome to USPS Label Portal - Account Created`,
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        <h2 style="color: #007bff;">Welcome to USPS Label Portal!</h2>
        <p>Hello ${userName},</p>
  ...
  passwordReset: (userName, resetUrl) => ({
    subject: `Password Reset Request - USPS Label Portal`,
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        <h2 style="color: #dc3545;">Password Reset Request</h2>
        <p>Hello ${userName},</p>
        <p>You requested a password reset for your USPS Label Portal account.</p>
